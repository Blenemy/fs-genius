...
const envSchema = z.object({
  ...
  // Redis нужен только воркеру (очереди и канал прогресса), api к нему
  // не обращается. Пока воркер выключен, переменной может не быть —
  // сам воркер без неё не стартует и скажет об этом.
